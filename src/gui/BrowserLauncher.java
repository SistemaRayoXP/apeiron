 ...
 * certain platforms
 * that are not part of the standard JDK. What we're trying to do, though, is to
 * take something
 ...
 * found, will not cause this to do anything other than returning an error when
 * opening the
 * browser.
 * <p>
 * There are certain system requirements for this class, as it's running through
 * Runtime.exec(),
 * which is Java's way of making a native system call. Currently, this requires
 * that a Macintosh
 * have a Finder which supports the GURL event, which is true for Mac OS 8.0 and
 * 8.1 systems that
 * have the Internet Scripting AppleScript dictionary installed in the Scripting
 * Additions folder
 ...
 * The author
 * requests that he be notified of any application, applet, or other binary that
 * makes use of
...
public class BrowserLauncher {
     ...
     * only care
     * about the operating system, but some operating systems require us to switch
     * on the VM.
     */
     ...
     *         consider
     *         to be a standard web browser; instead, it's the application that gets
     *         called to
