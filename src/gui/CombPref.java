...
public class CombPref extends JPanel {
    ...
    public CombPref(AdDatos dat) {
        ...
        p1.setBorder(BorderFactory.createCompoundBorder(BorderFactory.createTitledBorder("General"),
        ...
        p2.setBorder(BorderFactory.createCompoundBorder(BorderFactory.createTitledBorder("Orden de los grupos"),
                BorderFactory.createEmptyBorder(5, 5, 5, 5)));
