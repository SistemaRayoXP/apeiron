...
public class GeneradorCatalogo {
    private static class RegistroCatalogo implements Comparable<RegistroCatalogo> {
        ...
        /**
         * No se puede hacer un simple split(",") porque los elementos de las lineas
         * pueden
    ...
    private static void generarCatalogoCentro(File archivo, char letraCentro) throws Exception {
        ...
        LectorHttp lector = new LectorHttp(
                SIIAU_SERVER + "/wco/scpcata.cataxcu?planp=Y&cup=" + letraCentro + "&ordenp=1&mostrarp=5&tipop=D");
        ...
        if (!"DEPARTAMENTO,AREA,CLAVE,MATERIA,CRED,TEORIA,PRACTICA,TIPO,NIVEL,PRERREQUISITOS,CORREQUISITOS,CARRERAS"
                .equals(header)) {
